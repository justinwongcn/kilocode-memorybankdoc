...
# 10. PRESERVE ORIGINAL LANGUAGE FOR COMMANDS AND OUTPUTS

- Terminal commands, CLI instructions, and system messages should remain in their original language
- Log outputs, error messages, and debug information should not be translated
- Technical terms and identifiers (e.g., `[Memory Bank: Active]`) should remain unchanged
- This ensures consistency across development environments and prevents confusion